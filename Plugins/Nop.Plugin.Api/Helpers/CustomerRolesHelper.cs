...
namespace Nop.Plugin.Api.Helpers
{
    public class CustomerRolesHelper : ICustomerRolesHelper
    {
        ...
        public async Task<bool> IsInGuestsRoleAsync(IList<CustomerRole> customerRoles)
        {
            return await Task.FromResult(customerRoles.Any(cr => cr.SystemName == NopCustomerDefaults.GuestsRoleName));
        }

        public async Task<bool> IsInRegisteredRoleAsync(IList<CustomerRole> customerRoles)
        {
            return await Task.FromResult(customerRoles.Any(cr => cr.SystemName == NopCustomerDefaults.RegisteredRoleName));
        }
    }
}
