...
namespace Nop.Plugin.Api.Helpers
{
    public class JsonHelper : IJsonHelper
    {
        ...
        public async Task<Dictionary<string, object>> GetRequestJsonDictionaryFromStreamAsync(Stream stream, bool rewindStream)
        {
            ...
            var requestBodyDictionary = await Task.Run(() => DeserializeToDictionary(json));
        ...
        public async Task<string> GetRootPropertyNameAsync<T>() where T : class, new()
        {
            var rootProperty = "";

            var jsonObjectAttribute = await Task.Run(() => ReflectionHelper.GetJsonObjectAttribute(typeof(T)));
