...
namespace Nop.Plugin.Api.Helpers
{
    ...
    {
        public async Task MergeAsync(object source, object destination)
        {
            var sourcePropertyValuePairs = source.GetType()
                                                 .GetProperties()
                                                 .ToDictionary(property => property.Name, property => property.GetValue(source));

            await SetValuesAsync(sourcePropertyValuePairs, destination, destination.GetType(), null);
        }
            ...
            bool handleComplexTypeCollections)
        {
            ...
            if (propertyToUpdate != null)
            {
                ...
                if (propertyValue is Dictionary<string, object>)
                {
                    ...
                    SetValuesAsync((Dictionary<string, object>) propertyValue, valueToUpdate,
            ...
            Dictionary<object, object> objectPropertyNameValuePairs, bool handleComplexTypeCollections)
        {
            if (newProperties.ContainsKey("Id"))
            {
                ...
                else
                {
                    ...
                    SetValuesAsync(newProperties, itemToBeUpdated, collectionElementsType, objectPropertyNameValuePairs, handleComplexTypeCollections);
                }
            }
            // It is a new item.
            else
            ...
            bool handleComplexTypeCollections)
        {
            ...
            SetValuesAsync(newProperties, newInstance, collectionElementsType, objectPropertyNameValuePairs, handleComplexTypeCollections);
