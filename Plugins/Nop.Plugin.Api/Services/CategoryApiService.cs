...
namespace Nop.Plugin.Api.Services
{
    public class CategoryApiService : ICategoryApiService
    {
            ...
            bool? publishedStatus = null)
        {
            ...
            return await Task.Run(() => new ApiList<Category>(query, page - 1, limit));
        }
        ...
        public async Task<Category> GetCategoryByIdAsync(int id)
        {
            ...
            var category = await Task.Run(() => _categoryRepository.Table.FirstOrDefault(cat => cat.Id == id && !cat.Deleted));
            ...
            bool? publishedStatus = null, int? productId = null)
        {
            ...
            return await Task.Run(() => query.CountAsync(c => _storeMappingService.AuthorizeAsync(c).Result));
