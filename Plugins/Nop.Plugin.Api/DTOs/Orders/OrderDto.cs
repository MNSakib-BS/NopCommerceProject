...
namespace Nop.Plugin.Api.DTO.Orders
{
    ...
    public class OrderDto : BaseDto
    {
        ...
        ///     Gets or sets the customer
        /// </summary>
        [JsonProperty("allocated_to_driver")]
        public CustomerDto AllocatedToDriver { get; set; }
        ...
        /// <summary>
        /// Gets or sets the sales order barcode for this order
        /// </summary>
        [JsonProperty("sales_order_barcode")]
        public string SalesOrderBarcode { get; set; }

        /// <summary>
        /// Gets or sets the order notes for this order
        /// </summary>
        [JsonProperty("order_notes")]
        public IList<OrderNoteDto> OrderNotes { get; set; }

        /// <summary>
        /// Gets or sets the return requests for this order
        /// </summary>
        [JsonProperty("return_requests")]
        public IList<ReturnRequestDto> ReturnRequests { get; set; }

        /// <summary>
        /// Gets or sets the OTP for this order
        /// </summary>
        [JsonProperty("one_time_pin")]
        public string OneTimePin { get; set; }

        /// <summary>
        /// Gets or sets the date and time of estimated delivery date
        /// </summary>
        [JsonProperty("estimated_delivery_date")]
        public DateTime? EstimatedDeliveryDate { get; set; }

        /// <summary>
        /// Gets or sets the distance from the store 
        /// </summary>
        [JsonProperty("distance_from_store_to_shipping_address")]
        public string DistanceFromStoreToShippingAddress { get; set; }

        /// <summary>
        /// Gets or sets shipping status ID if set by manager
        /// </summary>
        [JsonProperty("admin_shipping_status_update_id")]
        public int? AdminShippingStatusUpdateId { get; set; }
