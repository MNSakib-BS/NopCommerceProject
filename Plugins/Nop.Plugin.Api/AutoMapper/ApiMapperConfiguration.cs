...
using Nop.Plugin.Arch.Core.Domains.Mobile;
...
namespace Nop.Plugin.Api.AutoMapper
{
    public class ApiMapperConfiguration : Profile, IOrderedMapperProfile
    {
        public ApiMapperConfiguration()
        {
            ...
            CreateCustomerDTOToDriverDTOMap();

            CreateOrderNoteToDTOMap();

            CreateReturnRequestToDTOMap();

            CreateMobileSettingsToDTOMap();
        }
        ...
        private void CreateCustomerDTOToDriverDTOMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<CustomerDto, DriverDto>()
                                      .IgnoreAllNonExisting();
        }

        private void CreateOrderNoteToDTOMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<OrderNote, OrderNoteDto>()
                                      .IgnoreAllNonExisting();
        }

        private void CreateReturnRequestToDTOMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<ReturnRequest, ReturnRequestDto>()
                                      .IgnoreAllNonExisting();
        }
        ...
        private void CreateMobileSettingsToDTOMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<MobileSettings, MobileSettingsDto>()
                                      .IgnoreAllNonExisting();
        }
    }
}
