                ...
                RuleFor(x => x.RoleIds)
                    ...
                    .DependentRules(() => RuleFor(dto => dto.RoleIds)
                                          .Must(async roleIds =>
                                          {
                                              ...
                                              var isInGuestAndRegisterRoles =await _customerRolesHelper.IsInGuestsRoleAsync(customerRoles) &&
                                                                             await _customerRolesHelper.IsInRegisteredRoleAsync(customerRoles);
                                          ...
                                          .DependentRules(() => RuleFor(dto => dto.RoleIds)
                                                                .Must(async roleIds =>
                                                                {
                                                                    ...
                                                                    var isInGuestOrRegisterRoles =await _customerRolesHelper.IsInGuestsRoleAsync(customerRoles) ||
                                                                                                  await _customerRolesHelper.IsInRegisteredRoleAsync(customerRoles);
