...
{
    public class ProductSpecificationAttributesController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetProductSpecificationAttributes(ProductSpecificationAttributesParametersModel parameters)
        {
            ...
            var productSpecificationAttribtues =
                await _specificationAttributeApiService.GetProductSpecificationAttributesAsync(parameters.ProductId, parameters.SpecificationAttributeOptionId,
                                                                                    parameters.AllowFiltering, parameters.ShowOnProductPage, parameters.Limit,
                                                                                    parameters.Page, parameters.SinceId);

            var productSpecificationAttributeDtos = productSpecificationAttribtues.Select(x => _dtoHelper.PrepareProductSpecificationAttributeDtoAsync(x)).ToList();
        ...
        {
            var productSpecificationAttributesCount =
                await _specificationAttributeService.GetProductSpecificationAttributeCountAsync(parameters.ProductId, parameters.SpecificationAttributeOptionId);
        ...
        public async Task<IActionResult> GetProductSpecificationAttributeById(int id, string fields = "")
        {
            ...
            var productSpecificationAttributeDto = await _dtoHelper.PrepareProductSpecificationAttributeDtoAsync(productSpecificationAttribute);
