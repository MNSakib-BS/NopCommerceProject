...
{
    public class ShoppingCartItemsController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetShoppingCartItems(ShoppingCartItemsParametersModel parameters)
        {
            ...
            IList<ShoppingCartItem> shoppingCartItems = await _shoppingCartItemApiService.GetShoppingCartItemsAsync(null,
            ...
            var shoppingCartItemsDtos = shoppingCartItems.Select(async shoppingCartItem => { return await _dtoHelper.PrepareShoppingCartItemDTOAsync(shoppingCartItem); })
                                                         .ToList();
        ...
        public async Task<IActionResult> GetShoppingCartItemsByCustomerId(int customerId, ShoppingCartItemsForCustomerParametersModel parameters)
        {
            ...
            var shoppingCartItemsDtos = shoppingCartItems
                                        .Select(shoppingCartItem => await _dtoHelper.PrepareShoppingCartItemDTOAsync(shoppingCartItem))
                                        .ToList();
        ...
        public async Task<IActionResult> DeleteShoppingCartItem(int id)
        {
            ...
            //activity log
            await CustomerActivityService.InsertActivityAsync("DeleteShoppingCartItem", await LocalizationService.GetResourceAsync("ActivityLog.DeleteShoppingCartItem"),
                                                   shoppingCartItemForDelete);
