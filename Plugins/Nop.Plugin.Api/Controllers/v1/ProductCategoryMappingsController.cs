...
{
    public class ProductCategoryMappingsController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetMappings(ProductCategoryMappingsParametersModel parameters)
        {
            ...
            IList<ProductCategoryMappingDto> mappingsAsDtos =
                await _productCategoryMappingsService.GetMappingsAsync(parameters.ProductId,
        ...
        public async Task<IActionResult> GetMappingsCount(ProductCategoryMappingsCountParametersModel parameters)
        {
            ...
            var mappingsCount = await _productCategoryMappingsService.GetMappingsCountAsync(parameters.ProductId,
                                                                                 parameters.CategoryId);
            ...
            Delta<ProductCategoryMappingDto> productCategoryDelta)
        {
            ...
            var category = await _categoryApiService.GetCategoryByIdAsync(productCategoryDelta.Dto.CategoryId.Value);
            if (category == null)
            {
                return Error(HttpStatusCode.NotFound, "category_id", "not found");
            }

            var product = await _productApiService.GetProductByIdAsync(productCategoryDelta.Dto.ProductId.Value);
            if (product == null)
            {
                return Error(HttpStatusCode.NotFound, "product_id", "not found");
            }

            var mappingsCount = await _productCategoryMappingsService.GetMappingsCountAsync(product.Id, category.Id);
            ...
            Delta<ProductCategoryMappingDto> productCategoryDelta)
        {
            ...
            //activity log
            await CustomerActivityService.InsertActivityAsync("UpdateProdutCategoryMapping",
                                             await LocalizationService.GetResourceAsync("ActivityLog.UpdateProdutCategoryMapping"), productCategoryEntityToUpdate);
        ...
        public async Task< IActionResult> DeleteProductCategoryMapping(int id)
        {
            ...
            //activity log 
            await CustomerActivityService.InsertActivityAsync("DeleteProductCategoryMapping", await LocalizationService.GetResourceAsync("ActivityLog.DeleteProductCategoryMapping"),
                                                   productCategory);
