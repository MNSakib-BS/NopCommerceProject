...
{
    public class CustomersController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetCustomers(CustomersParametersModel parameters)
        {
            ...
            var allCustomers =
                await _customerApiService.GetCustomersDtosAsync(parameters.CreatedAtMin, parameters.CreatedAtMax, parameters.Limit, parameters.Page, parameters.SinceId);
            ...
            Delta<CustomerDto> customerDelta)
        {
            ...
            if (customerDelta.Dto.Addresses.Count > 0)
            {
                ...
                foreach (var passedAddress in customerDelta.Dto.Addresses)
                {
                    ...
                    {
                        await _mappingHelper.MergeAsync(passedAddress, currentCustomerAddresses[passedAddress.Id]);
                    }
                    else
                    {
