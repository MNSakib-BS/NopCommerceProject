...
{
    public class NewsLetterSubscriptionController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetNewsLetterSubscriptions(NewsLetterSubscriptionsParametersModel parameters)
        {
            ...
            var newsLetterSubscriptions = _newsLetterSubscriptionApiService.GetNewsLetterSubscriptionsAsync(parameters.CreatedAtMin, parameters.CreatedAtMax,
        ...
        public async Task<IActionResult> DeactivateNewsLetterSubscription(string email)
        {
            ...
            var existingSubscription =await _newsLetterSubscriptionService.GetNewsLetterSubscriptionByEmailAndStoreIdAsync(email, _storeContext.GetCurrentStoreAsync().Id);
