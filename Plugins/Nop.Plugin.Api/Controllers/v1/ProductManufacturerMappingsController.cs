...
{
    public class ProductManufacturerMappingsController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetMappings(ProductManufacturerMappingsParametersModel parameters)
        {
            ...
            IList<ProductManufacturerMappingsDto> mappingsAsDtos =
                await _productManufacturerMappingsService.GetMappingsAsync(parameters.ProductId,
        ...
        public async Task<IActionResult> GetMappingsCount(ProductManufacturerMappingsCountParametersModel parameters)
        {
            ...
            var mappingsCount = await _productManufacturerMappingsService.GetMappingsCountAsync(parameters.ProductId,
                                                                                     parameters.ManufacturerId);
            ...
            Delta<ProductManufacturerMappingsDto> productManufacturerDelta)
        {
            ...
            var Manufacturer = await _manufacturerApiService.GetManufacturerByIdAsync(productManufacturerDelta.Dto.ManufacturerId.Value);
            if (Manufacturer == null)
            {
                return Error(HttpStatusCode.NotFound, "manufacturer_id", "not found");
            }

            var product = await _productApiService.GetProductByIdAsync(productManufacturerDelta.Dto.ProductId.Value);
            if (product == null)
            {
                return Error(HttpStatusCode.NotFound, "product_id", "not found");
            }

            var mappingsCount = await _productManufacturerMappingsService.GetMappingsCountAsync(product.Id, Manufacturer.Id);
            ...
            //activity log 
            await CustomerActivityService.InsertActivityAsync("AddNewProductManufacturerMapping",
                                                 await LocalizationService.GetResourceAsync("ActivityLog.AddNewProductManufacturerMapping"), newProductManufacturer);
            ...
            Delta<ProductManufacturerMappingsDto> productManufacturerDelta)
        {
            ...
            await CustomerActivityService.InsertActivityAsync("UpdateProdutManufacturerMapping",
                                                  await LocalizationService.GetResourceAsync("ActivityLog.UpdateProdutManufacturerMapping"),
        ...
        public async Task<IActionResult> DeleteProductManufacturerMapping(int id)
        {
            ...
            //activity log 
            await CustomerActivityService.InsertActivityAsync("DeleteProductManufacturerMapping",
                                                   await LocalizationService.GetResourceAsync("ActivityLog.DeleteProductManufacturerMapping"), productManufacturer);
