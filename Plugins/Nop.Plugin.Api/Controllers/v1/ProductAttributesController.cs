...
{
    public class ProductAttributesController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetProductAttributes(ProductAttributesParametersModel parameters)
        {
            ...
            var allProductAttributes = await _productAttributesApiService.GetProductAttributesAsync(parameters.Limit, parameters.Page, parameters.SinceId);

            IList<ProductAttributeDto> productAttributesAsDtos =
                allProductAttributes.Select(async productAttribute => await _dtoHelper.PrepareProductAttributeDTOAsync(productAttribute)).ToList();
        ...
        {
            var allProductAttributesCount = await _productAttributesApiService.GetProductAttributesCountAsync();
        ...
        public async Task< IActionResult> GetProductAttributeById(int id, string fields = "")
        {
            ...
            var productAttributeDto = await _dtoHelper.PrepareProductAttributeDTOAsync(productAttribute);
