...
{
    public class ManufacturersController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetManufacturers(ManufacturersParametersModel parameters)
        {
            ...
            var allManufacturers =(await _manufacturerApiService.GetManufacturersAsync(parameters.Ids, parameters.CreatedAtMin, parameters.CreatedAtMax,
            ...
            IList<ManufacturerDto> manufacturersAsDtos = allManufacturers.SelectAwait(async manufacturer => await _dtoHelper.PrepareManufacturerDtoAsync(manufacturer)).ToList();
        ...
        {
            var allManufacturersCount =await _manufacturerApiService.GetManufacturersCountAsync(parameters.CreatedAtMin, parameters.CreatedAtMax,
                                                                                      parameters.UpdatedAtMin, parameters.UpdatedAtMax,
        ...
        public async Task<IActionResult> GetManufacturerById(int id, string fields = "")
        {
            ...
            var manufacturer =await _manufacturerApiService.GetManufacturerByIdAsync(id);
            ...
            Delta<ManufacturerDto> manufacturerDelta)
        {
            ...
            await CustomerActivityService.InsertActivityAsync("AddNewManufacturer",
                                                 await  LocalizationService.GetResourceAsync("ActivityLog.AddNewManufacturer"), manufacturer);
            ...
            Delta<ManufacturerDto> manufacturerDelta)
        {
            ...
            var manufacturer =await _manufacturerApiService.GetManufacturerByIdAsync(manufacturerDelta.Dto.Id);
        ...
        public async Task<IActionResult> DeleteManufacturer(int id)
        {
            ...
            var manufacturerToDelete =await _manufacturerApiService.GetManufacturerByIdAsync(id);
