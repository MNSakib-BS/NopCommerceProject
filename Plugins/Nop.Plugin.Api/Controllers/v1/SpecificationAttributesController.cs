...
{
    public class SpecificationAttributesController : SecureBaseApiController
    {
        ...
        public async Task<IActionResult> GetSpecificationAttributes(SpecificationAttributesParametersModel parameters)
        {
            ...
            var specificationAttribtues = await _specificationAttributeApiService.GetSpecificationAttributesAsync(parameters.Limit, parameters.Page, parameters.SinceId);

            var specificationAttributeDtos = specificationAttribtues.Select(async x => await _dtoHelper.PrepareSpecificationAttributeDtoAsync(x)).ToList();

            var specificationAttributesRootObject = new SpecificationAttributesRootObjectDto
                                                    {
                                                        SpecificationAttributes = (IList<SpecificationAttributeDto>)specificationAttributeDtos
                                                    };
        ...
        public async Task<IActionResult> GetSpecificationAttributeById(int id, string fields = "")
        {
            ...
            var specificationAttributeDto = await _dtoHelper.PrepareSpecificationAttributeDtoAsync(specificationAttribute);
            ...
            Delta<SpecificationAttributeDto> specificaitonAttributeDelta)
        {
            ...
            await CustomerActivityService.InsertActivityAsync("AddNewSpecAttribute", await LocalizationService.GetResourceAsync("ActivityLog.AddNewSpecAttribute"),
            ...
            Delta<SpecificationAttributeDto> specificationAttributeDelta)
        {
            ...
            CustomerActivityService.InsertActivityAsync("EditSpecAttribute", await LocalizationService.GetResourceAsync("ActivityLog.EditSpecAttribute"), specificationAttribute);
        ...
        public async Task<IActionResult> DeleteSpecificationAttribute(int id)
        {
            ...
            //activity log
            await CustomerActivityService.InsertActivityAsync("DeleteSpecAttribute", await LocalizationService.GetResourceAsync("ActivityLog.DeleteSpecAttribute"),
                                                   specificationAttribute);
