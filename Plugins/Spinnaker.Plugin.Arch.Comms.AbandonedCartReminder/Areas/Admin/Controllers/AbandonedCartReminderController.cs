...
namespace Spinnaker.Plugin.Arch.AbandonedCartReminder.Areas.Admin.Controllers
{
    public class AbandonedCartReminderController : BaseAdminController
    {
        ...
        public async Task<IActionResult> Create(AbandonedCartReminderModel model, bool continueEditing)
        {
            ...
            var abandonedCartReminder = saveModel.ToEntity<Nop.Arch.Domain.AbandonedCartReminder.AbandonedCartReminder>();
        ...
        [HttpPost]
        public async Task<IActionResult> Delete(Nop.Arch.Domain.AbandonedCartReminder.AbandonedCartReminder abandonedCartReminder)
        {
        ...
        protected virtual async Task SaveStoreMappingsAsync(Nop.Arch.Domain.AbandonedCartReminder.AbandonedCartReminder reminder, AbandonedCartReminderModel model)
        {
