...
namespace Nop.Plugin.NopStation.MegaMenu
{
    public class MegaMenuPlugin : BasePlugin, IAdminMenuPlugin, INopStationPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await this.NopStationPluginInstallAsync(new MegaMenuPermissionProvider());
        ...
        public List<KeyValuePair<string, string>> PluginResouces()
        {
            ...
            list.Add(new KeyValuePair<string, string>("NopStation.MegaMenu.Public.Other.Navs", "More Categories"));
        ...
        {
            await this.NopStationPluginUninstallAsync(new MegaMenuPermissionProvider());
