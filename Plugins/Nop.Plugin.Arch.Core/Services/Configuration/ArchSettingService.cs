...
namespace Nop.Plugin.Arch.Core.Services.Configuration;
public partial class ArchSettingService : SettingService
{
    #region Fields
    ...
    public ArchSettingService(IRepository<Setting> settingRepository,
