...
/// Address service
/// </summary>
public partial class ArchAddressService : AddressService
{
    ...
    public ArchAddressService(AddressSettings addressSettings,
                              IAttributeParser<AddressAttribute,
                              AddressAttributeValue> addressAttributeParser,
                              IAttributeService<AddressAttribute,
                              AddressAttributeValue> addressAttributeService,
