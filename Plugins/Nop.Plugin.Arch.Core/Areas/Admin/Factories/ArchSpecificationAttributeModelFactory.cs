...
/// </summary>
public partial class ArchSpecificationAttributeModelFactory : ISpecificationAttributeModelFactory
{
    #region Fields
    ...
    public ArchSpecificationAttributeModelFactory(IBaseAdminModelFactory baseAdminModelFactory,
