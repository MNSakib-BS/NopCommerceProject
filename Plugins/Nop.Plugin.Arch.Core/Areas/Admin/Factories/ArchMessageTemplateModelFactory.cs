...
/// </summary>
public partial class ArchMessageTemplateModelFactory : IMessageTemplateModelFactory
{
    #region Fields
    ...
    public ArchMessageTemplateModelFactory(CatalogSettings catalogSettings,
