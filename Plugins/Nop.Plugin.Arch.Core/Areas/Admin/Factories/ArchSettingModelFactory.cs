...
/// </summary>
public partial class ArchSettingModelFactory : ISettingModelFactory
{
    #region Fields
    ...
    public ArchSettingModelFactory(AppSettings appSettings,
    ...
    protected override FullTextSettingsModel PrepareFullTextSettingsModel()
    {
        //load settings for a chosen store scope
