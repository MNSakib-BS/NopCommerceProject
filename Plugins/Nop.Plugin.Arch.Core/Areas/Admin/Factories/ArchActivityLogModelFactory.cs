...
/// </summary>
public partial class ArchActivityLogModelFactory : IActivityLogModelFactory
{
    #region Fields
    ...
    public ArchActivityLogModelFactory(IBaseAdminModelFactory baseAdminModelFactory,
