...
/// </summary>
public partial class ArchCustomerRoleModelFactory : ICustomerRoleModelFactory
{
    #region Fields
    ...
    public ArchCustomerRoleModelFactory(IBaseAdminModelFactory baseAdminModelFactory,
