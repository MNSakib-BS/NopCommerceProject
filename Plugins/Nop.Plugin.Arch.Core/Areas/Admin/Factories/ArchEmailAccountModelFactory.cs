...
/// </summary>
public partial class ArchEmailAccountModelFactory : IEmailAccountModelFactory
{
    #region Fields
    ...
    public ArchEmailAccountModelFactory(EmailAccountSettings emailAccountSettings,
