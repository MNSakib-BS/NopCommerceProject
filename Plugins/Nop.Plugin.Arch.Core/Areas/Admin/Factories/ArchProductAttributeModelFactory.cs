...
/// </summary>
public partial class ArchProductAttributeModelFactory : IProductAttributeModelFactory
{
    #region Fields
    ...
    public ArchProductAttributeModelFactory(ILocalizationService localizationService,
