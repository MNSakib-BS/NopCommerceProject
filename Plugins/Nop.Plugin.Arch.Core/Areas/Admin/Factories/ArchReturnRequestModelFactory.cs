...
/// </summary>
public partial class ArchReturnRequestModelFactory : IReturnRequestModelFactory
{
    #region Fields
    ...
    public ArchReturnRequestModelFactory(IBaseAdminModelFactory baseAdminModelFactory,
