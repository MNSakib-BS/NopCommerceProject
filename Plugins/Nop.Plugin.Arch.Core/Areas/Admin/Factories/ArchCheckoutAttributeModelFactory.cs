...
/// </summary>
public partial class ArchCheckoutAttributeModelFactory : ICheckoutAttributeModelFactory
{
    #region Fields
    ...
    public ArchCheckoutAttributeModelFactory(CurrencySettings currencySettings,
