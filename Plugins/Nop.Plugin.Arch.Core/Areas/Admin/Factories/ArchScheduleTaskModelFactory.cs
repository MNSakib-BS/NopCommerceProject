...
/// </summary>
public partial class ArchScheduleTaskModelFactory : IScheduleTaskModelFactory
{
    #region Fields
    ...
    public ArchScheduleTaskModelFactory(IDateTimeHelper dateTimeHelper,
    ...
    private bool IsStoppable(ScheduleTask scheduleTask)
    {
        ...
        return type.Implements(typeof(IStoppableScheduleTask));
    }
}