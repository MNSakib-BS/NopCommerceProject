...
public partial class ArchSpecificationAttributeController : BaseAdminController
{
    #region Fields
    ...
    public ArchSpecificationAttributeController(ICustomerActivityService customerActivityService,
