...
public partial class ArchRoxyFilemanController : BaseAdminController
{
    #region Fields
    ...
    public ArchRoxyFilemanController(IPermissionService permissionService, IRoxyFilemanService roxyFilemanService, IWebHelper webHelper)
    {
