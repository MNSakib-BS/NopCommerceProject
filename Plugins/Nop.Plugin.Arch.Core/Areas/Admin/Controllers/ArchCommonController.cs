...
public partial class ArchCommonController : BaseAdminController
{
    #region Const
    ...
    public ArchCommonController(ICommonModelFactory commonModelFactory,
    ...
    public virtual IActionResult Hangfire()
    {
        return Redirect("/Admin/Jobschedules");
    }
