...
public partial class ArchProductAttributeController : BaseAdminController
{
    #region Fields
    ...
    public ArchProductAttributeController(ICustomerActivityService customerActivityService,
