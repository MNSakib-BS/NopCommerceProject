...
public partial class ArchNewsLetterSubscriptionController : BaseAdminController
{
    #region Fields
    ...
    public ArchNewsLetterSubscriptionController(IDateTimeHelper dateTimeHelper,
