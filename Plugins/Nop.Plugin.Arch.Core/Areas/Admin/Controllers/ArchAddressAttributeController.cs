...
using Nop.Plugin.Arch.Core.Areas.Admin.Controllers;
...
{
    public partial class ArchAddressAttributeController : BaseAdminController
    {
        #region Fields
        ...
        public ArchAddressAttributeController(IAddressAttributeModelFactory addressAttributeModelFactory,
