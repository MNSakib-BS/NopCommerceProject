...
public partial class ArchCustomerAttributeController : BaseAdminController
{
    #region Fields
    ...
    public ArchCustomerAttributeController(IAttributeService<CustomerAttribute, CustomerAttributeValue> customerAttributeService,
