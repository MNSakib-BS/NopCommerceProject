...
public partial class ArchReturnRequestController : BaseAdminController
{
    #region Fields
    ...
    public ArchReturnRequestController(ICustomerActivityService customerActivityService,
