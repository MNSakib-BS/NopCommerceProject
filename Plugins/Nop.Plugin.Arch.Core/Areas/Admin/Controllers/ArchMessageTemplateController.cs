...
public partial class ArchMessageTemplateController : BaseAdminController
{
    #region Fields
    ...
    public ArchMessageTemplateController(ICustomerActivityService customerActivityService,
