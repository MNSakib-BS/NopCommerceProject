...
public partial class ArchVendorAttributeController : BaseAdminController
{
    #region Fields
    ...
    public ArchVendorAttributeController(IAttributeService<VendorAttribute, VendorAttributeValue> vendorAttributeService,
